...
- The workflow generates computational panels corresponding to the revised manuscript Figures 1-4.
- Figure 1A, Figure 2A, and Figure 3A are Venn-style overlap summaries.
- mRNA volcano y-values are capped at 50 for visualization; exact P-values remain in the tables.
